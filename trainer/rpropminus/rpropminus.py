...
class RpropMinus(Optimizer):
    def __init__(self, params, lr=0.012, etaminus=0.5, etaplus=1.2, delta_min=1e-6, delta_max=50):
        ...
        super(RpropMinus, self).__init__(params, defaults)
    ...
    def step(self):
        for group in self.param_groups:
            ...
            for parameter in group['params']:
                ...
                step_size[increase_mask] = torch.min(step_size[increase_mask] * eta_plus, torch.tensor(delta_max, device=parameter.device))
                ...
                update[increase_mask | (grad_sign == 0) | decrease_mask] = -torch.sign(grad[increase_mask | (grad_sign == 0) | decrease_mask]) * step_size[increase_mask | (grad_sign == 0) | decrease_mask]
