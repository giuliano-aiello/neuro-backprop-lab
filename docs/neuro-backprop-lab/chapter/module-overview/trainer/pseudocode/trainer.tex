\begin{algorithm}
    ...
    \Fn{\traineval{$model$, $criterion$, $optimizer$, $train\_set$, $eval\_set$, $epochs$}}{
        \ForEach{$epoch \in epochs$}{
            ...
            $eval\_loss\_avg, eval\_accuracy \gets eval(model, criterion, eval\_set, eval\_loss\_avgs, eval\_accuracies)$
        }
    ...
    \SetKwProg{Fn}{Function}{:}{\KwRet}
    \Fn{\train{$model$, $criterion$, $train\_set$, $loss\_averages$, $accuracies$}}{
